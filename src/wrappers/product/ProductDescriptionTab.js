...
const ProductDescriptionTab = ({ spaceBottomClass, productFullDesc, id, reviews }) => {
        ...
        <div className="description-review-wrapper">
          <Tab.Container defaultActiveKey="productReviews">
            <Nav variant="pills" className="description-review-topbar">
              ...
              <Nav.Item>
                <Nav.Link eventKey="productReviews">Reviews{`(${reviews ? reviews.length : ''})`}</Nav.Link>
              </Nav.Item>
            </Nav>
