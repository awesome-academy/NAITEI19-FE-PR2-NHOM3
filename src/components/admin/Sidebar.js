  ...
  return (
    <div className="p-2">
      ...
      <div className="list-group list-group-flush">
        ...
        <a href="/admin/orders" className="list-group-item list-group-item-action py-2 sidebar-item">
          <span className="d-inline-block mr-2"><i className="fa fa-shopping-cart fs-5"></i></span>
